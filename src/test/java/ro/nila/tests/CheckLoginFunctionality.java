...
public class CheckLoginFunctionality extends TestBase {
    ...
    public void testToCheckLoginFunctionality() {
        ...
        Checkpoints.checkElementContainsExactText("ui.homePage.welcome.css", "txt.home.welcome.message");
...
//        Checkpoints.checkElementContainsExactText("ui.recipesPage.message.css", "txt.recipesPage.message");
